...
export const ENCOUNTERS: Record<string, EncounterDef> = {
  ...
  eliteSpider: {
    ...
    backgroundAssetId: 'bg.nest',
    phases: [{ ...TAPE_SPIDER, maxHp: 48, subtitle: 'elite — reinforced keeper' }],
    scrapReward: 14,
  },
  boss: {
    id: 'boss',
    ...
    backgroundAssetId: 'bg.nest',
    phases: [
      { ...TAPE_SPIDER, maxHp: 36, subtitle: 'boss phase 1 — nest keeper', intro: '드래프트보드 중심부를 지키는 거미가 먼저 길을 막는다.' },
      {
        ...SCISSOR_CROW,
        maxHp: 42,
